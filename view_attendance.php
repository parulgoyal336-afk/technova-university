...
$att_stmt = $pdo->prepare("SELECT COUNT(*) as total, 
    ...
    <div class="stat-card" style="background: var(--light-color); border: 1px solid rgba(212,175,55,0.2); text-align: center; padding: 2rem;">
        <div style="position: relative; display: inline-block;">
            <svg width="100" height="100" viewBox="0 0 100 100">
                ...
                <text x="50" y="55" text-anchor="middle" font-size="18" font-weight="700" fill="var(--primary-color)"><?php echo $percentage; ?>%</text>
            </svg>
        </div>
    ...
    <div class="glass-card" style="background: var(--light-color); border: 1px solid rgba(212,175,55,0.1); padding: 0;">
        ...
        <div style="padding: 1rem 2rem;">
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    <?php
                    $stmt = $pdo->prepare("SELECT a.*, c.course_name 
                                         FROM attendance a 
